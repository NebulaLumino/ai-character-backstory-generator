...
## App Details
- **Name:** ai-syllogism-validator
- **GitHub Repo:** https://github.com/NebulaLumino/ai-syllogism-validator
- **Description:** Input a syllogism (premises + conclusion) → validate structure, check for formal fallacies, and generate counterexamples.
